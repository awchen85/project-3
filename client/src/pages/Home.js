  ...
  return (
    <div>
      <div className="grid grid-cols-2 justify-items-stretch">
        <div className="justify-self-center absolute self-center">
        ...
        <div className="justify-self-end flex mw-auto lg:visible invisible">
          <img
            src={require(`../assets/images/badroommate.jpg`)}
            className="w-screen justify-around"
          ></img>
        </div>
      </div>
